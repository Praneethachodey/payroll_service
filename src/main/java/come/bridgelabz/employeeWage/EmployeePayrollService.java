...
public class EmployeePayrollService {
	...
	public List<EmployeePayRollData> readEmployeePayrollForDateRange(IOService ioService, LocalDate start, LocalDate end) {
	...
	private EmployeePayRollData getEmployeePayrollData(String name) {
		        return employeePayrollList.stream()
		                .filter(employeePayRollDataItem -> employeePayRollDataItem.name.equalsIgnoreCase(name))
		                .findFirst()
		                .orElse(null);	}
